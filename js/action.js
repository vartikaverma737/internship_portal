...
function getCareerPrediction(skills, education) {
    fetch('/predict-career', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        ...
        document.querySelector('.career-suggestion').innerText = data.career_suggestion;
    });
}

// Example usage
getCareerPrediction(['AI', 'Python'], 'B.Tech CSE-AI');
